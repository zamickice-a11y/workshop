...
(function () {
  ...
  const BIZ = () => (window.SIAM_CONFIG && (window.SIAM_CONFIG.ACTIVE_BUSINESS || window.SIAM_CONFIG.BUSINESS)) || {};
      ...
      <div class="head">
        ...
        <div class="ttl">
          ...
          <div class="biz">${esc(b.name)}
            ${b.legal_name ? `<small style="font-weight:600;color:#222">${esc(b.legal_name)}</small>` : ``}
  ...
  function repairHTML(d) {
    ...
    return `<div class="doc">
      ...
      <!-- JOB SHEET PAGE -->
      <div class="page">
        <div class="pno">Job Sheet / Work Order</div>
  ...
  function ppiHTML(d) {
    ...
    return `<div class="doc">
      <!-- INVOICE PAGE -->
      <div class="page">
        <div class="pno">Inspection Report</div>
        ${docHead("INVOICE")}
        ${headerTable(d, true)}
      ...
      <!-- REPORT PAGES -->
      <div class="page">
        <div class="pno">Inspection Report (cont.)</div>
        ${docHead("JOB SHEET / WORK ORDER + VEHICLE REPORT")}
        ${headerTable(d, true)}
        <table class="sect">
          ${sect("Customer Reported Issue:", nl2br(d.reported_issue))}
  ...
  function generateDocx(form, data) {
    ...
    const bizPara = () => [
      ...
      ...(b.legal_name ? [new Paragraph({ alignment: AlignmentType.RIGHT, children: [new TextRun({ text: b.legal_name, bold: true, size: 17 })] })] : []),
